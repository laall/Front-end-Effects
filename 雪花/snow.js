...
THREE.Color.prototype = {
  ...
  setHSV: function (a, b, c) {
    ...
    if (c === 0) this.r = this.g = this.b = 0
      ...
      switch (((d = Math.floor(a * 6)), (f = a * 6 - d), (a = c * (1 - b)), (e = c * (1 - b * f)), (b = c * (1 - b * (1 - f))), d)) {
        case 1:
          this.r = e
          this.g = c
          this.b = a
      ...
      for (W = G.faces.length; n < W; n++)
        if (
          ...
          if (((p = l.dot(m.sub(f, a)) / p), j.add(a, b.multiplyScalar(p)), i instanceof THREE.Face3))
            d(j, f, e, g) && ((i = { distance: a.distanceTo(j), point: j.clone(), face: i, object: k }), o.push(i))
      ...
      if (b.visible !== !1) {
        ...
        if ((c = b instanceof THREE.Mesh || b instanceof THREE.Line))
          if (!(c = b.frustumCulled === !1))
            a: {
              for (
                var d = b.matrixWorld, e = -b.geometry.boundingSphere.radius * Math.max(b.scale.x, Math.max(b.scale.y, b.scale.z)), h = 0;
                h < 6;
                h++
              )
  ...
  this.projectScene = function (a, e, f) {
    ...
    for (F = w.sprites.length; a < F; a++)
      if (
        ...
        (t = J.matrixWorld),
        J instanceof THREE.Particle && (z.set(t.n14, t.n24, t.n34, 1), D.multiplyVector4(z), (z.z /= z.w), z.z > 0 && z.z < 1))
      )
