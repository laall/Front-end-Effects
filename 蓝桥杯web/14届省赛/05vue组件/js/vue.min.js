...
!(function (t, e) {
      ...
      return (
        Object.defineProperty(t, n, {
          ...
          get: function () {
            var n = u ? u.call(t) : r;
            return (
              mt.target && (s.depend(), f && (f.dep.depend(), e(n) && Nt(n))),
              Ft(n) && !i ? n.value : n
            );
          },
          set: function (e) {
  ...
  function Be(t, e, n, r) {
    ...
    var i = t.$options[e],
      a = "".concat(e, " hook");
    if (i)
      for (var s = 0, c = i.length; s < c; s++) dn(i[s], t, n || null, t, a);
  ...
  function Un(t, n) {
    var r,
      ...
      i = e(t);
    if (
      !((!i && !s(t)) || t.__v_skip || Object.isFrozen(t) || t instanceof lt)
    ) {
      if (t.__ob__) {
  ...
  function nr(n, r, i, a, s) {
    ...
    (this.data = n),
      ...
      (this.slots = function () {
        return (
          u.$slots || be(a, n.scopedSlots, (u.$slots = ge(i, a))), u.$slots
        );
      }),
      ...
      if ((s(i) && (i = d.extend(i)), "function" == typeof i)) {
        ...
        if (o(i.options.functional))
          return (function (n, o, i, a, s) {
            ...
            if (e(p)) {
              for (
                var v = Xt(p) || [], h = new Array(v.length), m = 0;
                m < v.length;
                m++
              )
    ...
    if (!n(t.data.domProps) || !n(e.data.domProps)) {
      ...
      for (i in u) {
        ...
        if ("value" === i && "PROGRESS" !== s.tagName) {
          ...
          (oi = oi || document.createElement("div")).innerHTML = "<svg>".concat(
            a,
            "</svg>"
          );
              ...
              var b = (function () {
                ...
                if (e) {
                  ...
                  for (
                    ...
                    !(r = t.match(Na)) && (o = t.match(Ta) || t.match(Oa));
            ...
            Do(
              ...
              Fo(
                ...
                "var $$a=".concat(e, ",") +
                  ...
                  "else{$$i>-1&&(".concat(
                    Ko(e, "$$a.slice(0,$$i).concat($$a.slice($$i+1))"),
                    ")}"
                  ) +
                  "}else{".concat(Ko(e, "$$c"), "}"),
                null,
