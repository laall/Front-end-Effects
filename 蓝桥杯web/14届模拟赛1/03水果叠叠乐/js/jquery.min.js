            ...
            CLASS: function (a) {
              ...
              return (
                ...
                ((b = new RegExp('(^|' + M + ')' + a + '(' + M + '|$)')) &&
                  y(a, function (a) {
                    return b.test(
                      ('string' == typeof a.className && a.className) || (typeof a.getAttribute !== C && a.getAttribute('class')) || ''
                    )
                  }))
              )
            },
        ...
        n.event.special[a] = {
          ...
          handle: function (a) {
            var c,
              ...
              f = a.handleObj
            return (
              (!e || (e !== d && !n.contains(d, e))) && ((a.type = f.origType), (c = f.handler.apply(this, arguments)), (a.type = b)), c
            )
          }
        }
      }
